...
namespace Core
{
    public partial class DeviceMeasure
    {
        ...
        {
            //DeviceMeasureHorariosEnviosCard = new HashSet<DeviceMeasureHorariosEnviosCard>();
        }
        ...
        //public virtual ICollection<DeviceMeasureHorariosEnviosCard> DeviceMeasureHorariosEnviosCard { get; set; }
    }
}
